...
def program_add(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, request.POST.get(
...
def program_detail(request, pk):
    ...
    return render(request, 'course/program_single.html', {
        'title': program.title,
        'program': program, 'courses': courses, 'credits': credits, 'uploaded_image':uploaded_img
    }, )
...
def course_add(request, pk):
    ...
    return render(request, 'course/course_add.html', {
        ...
        'form': form, 'program': pk, 'users': users, 'uploaded_image':uploaded_img
    }, )
...
def edit_allocated_course(request, pk):
    ...
    return render(request, 'course/course_allocation_form.html', {
        'title': "Edit Subject Allocated",
        'form': form, 'allocated': pk, 'uploaded_image':uploaded_img
    }, )
...
def handle_file_upload(request, slug):
    ...
    return render(request, 'upload/upload_file_form.html', {
        'title': "File Upload ",
        'form': form, 'course': course, 'uploaded_image':uploaded_img
    })
...
def handle_video_single(request, slug, video_slug):
    ...
    return render(request, 'upload/video_single.html', {'video': video , 'uploaded_image':uploaded_img})
...
def user_course_list(request):
    ...
    if request.user.is_lecturer:
        ...
        return render(request, 'course/user_course_list.html', {'courses': courses, 'uploaded_image':uploaded_img})
        ...
        return render(request, 'course/user_course_list.html', {'uploaded_image':uploaded_img})
