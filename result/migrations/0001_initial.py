    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E'), ('F', 'F'), ('NG', 'NG')], max_length=2)),
                ('point', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('comment', models.CharField(blank=True, choices=[('Excellent', 'Excellent'), ('Very Good', 'Very good'), ('Good', 'Good'), ('Average', 'Average'), ('Bellow Average', 'Bellow Average'), ('FAIL', 'FAIL')], max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(choices=[('First Term', 'First Term'), ('Second', 'Second Term'), ('Third', 'Third Term')], max_length=100)),
